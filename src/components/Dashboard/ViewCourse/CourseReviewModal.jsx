    ...
    <div className="fixed inset-0 z-[1000] !mt-0 grid h-screen w-screen place-items-center overflow-auto bg-white bg-opacity-10 backdrop-blur-sm">
      <div className="my-10 w-11/12 max-w-[700px] rounded-lg border border-richblack-400 bg-white">
        ...
        <div className="flex items-center justify-between rounded-t-lg bg-richblack-700 p-5">
          <p className="text-xl font-semibold text-white font-walsheim">Add Review</p>
        ...
        <div className="p-6">
          <div className="flex items-center justify-center gap-x-4">
            ...
            <div className="">
              ...
              <p className="text-sm text-darkblue font-walsheimReg">Posting Publicly</p>
            </div>
          </div>
          <form
          ...
          >
            ...
            <div className="flex w-11/12 flex-col space-y-2">
              <label
                className="text-sm text-darkblue font-walsheimMed font-[600]"
