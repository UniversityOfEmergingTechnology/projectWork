              ...
              <div className="flex flex-col gap-2">
                {["About", "Careers", "Affiliates"].map((ele, i) => {
                  return (
                    <div
                      key={i}
                      className="text-[14px] cursor-pointer hover:font-extrabold transition-all duration-200"
                    >
                ...
                <div
                  ...
                  className={` ${
                    BottomFooter.length - 1 === i
                      ? ""
                      : "border-r border-richblack-700 cursor-pointer hover:font-extrabold transition-all duration-200"
                  } px-3 `}
                >
