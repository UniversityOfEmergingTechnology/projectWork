      ...
      {open && (
        ...
        >
          <Link to="/dashboard/my-profile" onClick={() => setOpen(false)}>
            ...
            text-[#4F547B] hover:bg-richblack-700 hover:text-richblack-25`}>
          ...
          <div
            ...
            className="flex w-full items-center gap-x-1 py-[10px] px-[12px] text-sm  text-[#4F547B] hover:bg-richblack-700 hover:text-richblack-25"
          >
