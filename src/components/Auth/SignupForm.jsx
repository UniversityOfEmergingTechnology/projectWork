  ...
  return (
    <div>
      ...
      <form onSubmit={handleOnSubmit} className="flex w-full flex-col gap-y-4">
        ...
        <div className="flex gap-x-4 lg:flex-row flex-col">
          <label className="relative">
            ...
            <input
              ...
              className="focus:text-black focus:bg-white font-walsheimReg w-full rounded-[0.5rem] bg-richblack-800 p-[12px] pr-10 text-[#F5F5DC]"
            />
            <span
        ...
        <button
          type="submit"
          className="mt-6 rounded-[8px] bg-yellow-50 py-[12px] px-[12px] font-medium text-richblack-900 font-walsheimCon duration-300 hover:scale-95"
        >
          Create Account
        </button>
      </form>
